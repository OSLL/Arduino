...
public class GdbDebugProcess implements GdbListener, BreakpointListener{
	...
	public GdbDebugProcess(Editor editor, String _host, int _port, String _elfFilePath) {
		...
		// Prepare GDB
		System.out.println(editor.getSketchController().getSketch().getFolder());
		System.out.println(editor.getSketchController().getSketch().getFolder().getAbsolutePath());
		System.out.println("Creating new Gdb: '" + editor.getSketchController().getSketch().getFolder().getAbsolutePath()+ "'");
		m_gdb = new Gdb("avr-gdb", editor.getSketchController().getSketch().getFolder().getAbsolutePath(), this);
